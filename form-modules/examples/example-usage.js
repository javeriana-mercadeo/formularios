...
const eventoOpenDayConfig = {
  ...
  attendanceDays: ["Viernes 15 de marzo", "Sábado 16 de marzo"],
...
const posgradoConfig = {
  ...
  academicLevels: [{ code: "GRAD", name: "Posgrado" }],

  // Filtrar facultades específicas
  faculties: ["Facultad de Ciencias", "Facultad de Ingeniería"],
...
const convenioConfig = {
  ...
  typeAttendee: ["Empleado", "Directivo", "Familiar"],
  ...
  callbacks: {
    onFormLoad: (formManager) => {
      ...
      formManager.validator.addErrorMessage(
        "required",
        "Este campo es requerido para el evento corporativo"
      );
    },
