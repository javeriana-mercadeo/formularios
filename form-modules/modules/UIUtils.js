...
export class UIUtils {
  ...
  toggleElement(element, show = null) {
    ...
    const isHidden = element.style.display === 'none' || 
                     element.classList.contains(this.config.hiddenClass);
  ...
  createAcademicLevelField(formElement) {
    ...
    academicLevelElement.parentNode.insertBefore(
      errorDiv, 
      academicLevelElement.nextSibling
    );
  ...
  showSuccessMessage(message, container = null) {
    const targetContainer = container || this.findElement('[data-success-msg]') || this.findElement('#successMsg');
