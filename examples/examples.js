...
// ============================================================================
// 🔄 PRUEBA 11: CONFIGURACIÓN HÍBRIDA - COLEGIOS Y UNIVERSIDADES
// ============================================================================
// Demuestra funcionamiento de ambos filtros según nivel académico seleccionado
// ✅ Usado en: formHybrid (test.html)

export const configHybrid = {
  // DATOS DEL EVENTO
  eventName: "Evento Híbrido Pregrado y Posgrado 2024",
  eventDate: "2024-12-10",
  campaign: "HIBRIDO_2024",
  article: "evento_hibrido",
  source: "prueba_tecnica",
  medium: "testing",
  ...
  attendanceDays: ["Martes 10 de diciembre de 2024"],
  ...
  // 💡 COMPORTAMIENTO ESPERADO (CASO HÍBRIDO):
  // ✅ Pregrado (PREG) + Aspirante/Padre → Solo colegios
  // ✅ Técnico (ETDH) + Aspirante/Padre → Solo colegios
  // ✅ Posgrado (GRAD) + Aspirante → Solo universidades
  // ✅ Nunca aparecen ambos campos simultáneamente
  // ✅ Campos reaccionan a cambios en nivel académico y tipo de asistente
  // ✅ Validación impide envío sin selección cuando campo está visible
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // 🔄 Prueba 11: Ejemplo Híbrido
  if (document.getElementById("formHybrid")) {
    const formHybrid = new FormModules("formHybrid", configHybrid);
    formHybrid.initialize();
  }
});
