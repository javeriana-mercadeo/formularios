...
document.addEventListener("DOMContentLoaded", function () {
 ...
 if (document.getElementById("formAcademicLevel")) {
  const formAcademicLevel = new FormModules(
   "formAcademicLevel",
   configAcademicLevel
  );
 ...
 if (document.getElementById("formMultipleDays")) {
  const formMultipleDays = new FormModules(
   "formMultipleDays",
   configMultipleDays
  );
 ...
 if (document.getElementById("formUniversities")) {
  const formUniversities = new FormModules(
   "formUniversities",
   configUniversities
  );
 ...
 if (document.getElementById("formCompaniesSchools")) {
  const formCompaniesSchools = new FormModules(
   "formCompaniesSchools",
   configCompaniesSchools
  );
