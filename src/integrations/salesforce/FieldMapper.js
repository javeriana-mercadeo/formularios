...
export class FieldMapper {
  ...
  getRequiredFields(formData = {}) {
    ...
    const alwaysRequired = [
      'first_name', 'last_name', 'email', 'type_attendee', 
      'attendance_day', 'authorization_data'
    ];
  ...
  getFieldInfo(fieldName, isTestMode = false) {
    const fieldMapping = Object.entries(Constants.FIELD_MAPPING).find(
      ([key, config]) => config.field === fieldName
    );
