...
export class Academic {
  ...
  async configureAcademicLevels(programsData) {
    try {
      ...
      const filteredLevels = allLevels.filter(level => programsAnalysis.levels.includes(level.code))
   ...
   */
  clearAcademicFields() {
    const fields = [Constants.FIELDS.ACADEMIC_LEVEL, Constants.FIELDS.FACULTY, Constants.FIELDS.PROGRAM, Constants.FIELDS.ADMISSION_PERIOD]
